    ...
    <x-dashing::auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                ...
                <x-dashing::input id="email" class="form-control form-control-lg" type="email" name="email" :value="old('email','admin@email.com')" required autofocus :placeholder="__('Email')" />
            </div>
            <div class="mt-4">
                <x-dashing::label for="password" :value="__('Password')" />
                <x-dashing::input id="password" class="form-control form-control-lg" type="password" name="password" required autocomplete="current-password" :placeholder="__('Password')" value="admin123" />
            </div>
